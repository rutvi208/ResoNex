...
import Tableau from '@/assets/certified/Tableau.png';
import Informatica from '@/assets/certified/Informatica.png';
import PowerBI from '@/assets/certified/PowerBI.png';
import Aws from '@/assets/certified/Aws.png';
import Azure from '@/assets/certified/Azure.png';
import GoogleCloud from '@/assets/certified/GoogleCloud.png';
import Salesforce from '@/assets/certified/Salesforce.png';
import Databricks from '@/assets/certified/Databricks.png';
import Snowflakes from '@/assets/certified/Snowflakes.png';
import Quickbase from '@/assets/certified/Quickbase.png';
            ...
            <section className="px-6 md:px-12 py-12 lg:pb-24">
                <div className="max-w-7xl mx-auto items-center place-items-center">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        ...
                        {/* <!-- Right: Text Content --> */}
                        <div>
                            <h3 className="text-[2.50rem] medium-text tracking-tight leading-none lg:w-8/12 bg-gradient-to-br sm:bg-gradient-to-r from-[#303030] via-[#32006C] via-[50%] to-[#4D4D4D] bg-clip-text text-transparent">
                    ...
                    <div>
                        <div className="max-w-7xl mt-12 lg:mt-24 mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
                            ...
                            <p className="text-sm lg:text-base medium-text text-[var(--foreground)]">
